...
# на третьем - три, и т.д., в нижнем ряду пирамиды 
# количество кирпичей равно количеству уровней пирамиды.
# После этого он написал на каждом кирпиче по числу, 
# равному количеству кирпичей на этом уровне,
